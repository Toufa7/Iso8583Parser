...
void init_data_elements (t_data_element *data_element) {
    ...
    data_element[41].type = f_40;

    data_element[42].name = calloc(strlen("Additional response data") + 1, sizeof(char));
    data_element[42].name = "Additional response data";
    data_element[42].type = llvar;

    data_element[43].name = calloc(strlen("Track 1 data") + 1, sizeof(char));
    data_element[43].name = "Track 1 data";
    data_element[43].type = llvar;

    data_element[44].name = calloc(strlen("Additional data - ISO") + 1, sizeof(char));
    data_element[44].name = "Additional data - ISO";
    data_element[44].type = lllvar;

    data_element[45].name = calloc(strlen("Additional data - national") + 1, sizeof(char));
    data_element[45].name = "Additional data - national";
    data_element[45].type = lllvar;

    data_element[46].name = calloc(strlen("Additional data - private") + 1, sizeof(char));
    data_element[46].name = "Additional data - private";
    data_element[46].type = lllvar;

    data_element[47].name = calloc(strlen("Currency code, transaction") + 1, sizeof(char));
    data_element[47].name = "Currency code, transaction";
    data_element[47].type = f_3;

    data_element[48].name = calloc(strlen("Currency code, settlement") + 1, sizeof(char));
    data_element[48].name = "Currency code, settlement";
    data_element[48].type = f_3;

    data_element[49].name = calloc(strlen("Currency code, cardholder billing") + 1, sizeof(char));
    data_element[49].name = "Currency code, cardholder billing";
    data_element[49].type = f_3;

    data_element[50].name = calloc(strlen("Personal identification number data") + 1, sizeof(char));
    data_element[50].name = "Personal identification number data";
    data_element[50].type = f_8;

    data_element[51].name = calloc(strlen("Security related control information") + 1, sizeof(char));
    data_element[51].name = "Security related control information";
    data_element[51].type = f_16;

    data_element[52].name = calloc(strlen("Additional amounts") + 1, sizeof(char));
    data_element[52].name = "Additional amounts";
    data_element[52].type = f_8;

    data_element[53].name = calloc(strlen("ICC Data - EMV having multiple tags") + 1, sizeof(char));
    data_element[53].name = "ICC Data - EMV having multiple tags";
    data_element[53].type = f_8;

    data_element[54].name = calloc(strlen("Reserved ISO") + 1, sizeof(char));
    data_element[54].name = "Reserved ISO";
    data_element[54].type = f_8;

    data_element[55].name = calloc(strlen("Reserved national") + 1, sizeof(char));
    data_element[55].name = "Reserved national";
    data_element[55].type = lllvar;

    data_element[56].name = calloc(strlen("Reserved national") + 1, sizeof(char));
    data_element[56].name = "Reserved national";
    data_element[56].type = lllvar;
    ...
    data_element[59].name = calloc(strlen("Reserved private (Ex: CVV2/Service Code)") + 1, sizeof(char));
    data_element[59].name = "Reserved private (Ex: CVV2/Service Code)";
    data_element[59].type = lllvar;

    data_element[60].name = calloc(strlen("Reserved private (Invoice Number, TPK Key") + 1, sizeof(char));
    data_element[60].name = "Reserved private (Invoice Number, TPK Key";
    data_element[60].type = lllvar;

    data_element[61].name = calloc(strlen("Reserved private") + 1, sizeof(char));
    data_element[61].name = "Reserved private";
    data_element[61].type = lllvar;

    data_element[62].name = calloc(strlen("Message authentication code (MAC)") + 1, sizeof(char));
    data_element[62].name = "Message authentication code (MAC)";
    data_element[62].type = b_8;
}